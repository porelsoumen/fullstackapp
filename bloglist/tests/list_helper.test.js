...
describe('total likes', () => {
    ...
    it('should return the some of likes of multiple blogs', () => {
...
describe('authors with most blogs', () => {
    it('should return the author with most number of blogs', () => {
...
describe('authors with most likes', () => {
    it('should return the author with most number of likes', () => {
